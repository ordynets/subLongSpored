...
Furthermore, this code shows how to plot the branch support values from two phylogenetic analyses onto single phylogenetic tree. The code is based on the R code from Samuel Crane (https://github.com/samuelcrane/label-node-support/blob/master/labelNodeSupport.r) and was adjusted for using on the own dataset of ca. 100 DNA sequences. 
